...
!function () {
    function e(e) {
        ...
        o.to = "backgroundjs", o.comefrom = "webframe", o.command = "COMMAND_FROM_ASJS", o.appid = C, o.appname = R, o.apphash = W, o.webviewID = webViewVersion, window.postMessage(o, "*")
    }

    function o(e) {
        e.command = "COMMAND_FROM_ASJS", e.appid = C, e.appname = R, e.apphash = W, e.webviewID = webViewVersion;
        var o = "____sdk____" + JSON.stringify(e), n = prompt(o);
        n = JSON.parse(n), delete n.to, a(n)
    }

    function n(e) {
        e.to = "contentscript", e.comefrom = "webframe", e.webviewID = webViewVersion, window.postMessage(e, "*")
    }
    ...
    function r(n, r, a) {
        var i = t();
        L[i] = a;
        var s = /Sync$/.test(n), c = {sdkName: n, args: r, callbackID: i};
        s ? o(c) : e(c)
    }
    ...
    function a(o) {
        ...
        if ("MSG_FROM_WEBVIEW" === n) {
            var c = t.eventName, u = t.type, p = t.data || {};
        ...
        }); else if ("WRITE_APP_DATA" === n)for (var l in t) {
            var g = t[l], f = g.__webviewId__;
    ...
    function i(e, o) {
        try {
            for (var n = F.projectConfig, t = n.Network, r = "webscoket" === o ? t.WsRequestDomain : t.RequestDomain, a = 0; a < r.length; a++)if (0 === e.indexOf(r[a]))return !0
        } catch (i) {
    ...
    function s(e, o, n) {
        if (G++, G > I)return G--, n && n({errMsg: "request:fail;"}), void console.error("%c 最多同时发起 " + I + " 个 wx.request 请求", "color: red; font-size: x-large");
        var t = o.url, r = o.header || {};
        if (!i(t))return G--, n && n({errMsg: "request:fail;"}), void console.error("%c URL 域名不合法，请在 mp 后台配置后重试", "color: red; font-size: x-large");
        var a, s = new XMLHttpRequest, c = o.method || "POST", u = (o.complete, F.networkTimeout && F.networkTimeout.request);
        ...
        "POST" != c || p || s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), "number" == typeof u && (a = setTimeout(function () {
            s.abort("timeout"), o.complete && o.complete(), o.complete = null, G--, n && n({errMsg: "request:fail"})
        }, u));
        var g = "string" == typeof o.data ? o.data : null;
        try {
            s.send(g)
        } catch (f) {
            G--, n && n({errMsg: "request:fail"})
        }
    }
    ...
    function p(e, o, n) {
        var t = o.url, r = o.header;
        if (!i(t, "webscoket"))return n && n({errMsg: "closeSocket:fail"}), void console.error("%c URL 域名不合法，请在 mp 后台配置后，重启项目继续测试", "color: red; font-size: x-large");
        j = new WebSocket(t);
    ...
    function d(e, o, n) {
        j ? (j.close(), j = null, n && n({errMsg: "closeSocket:ok"})) : n && n({errMsg: "closeSocket:fail"})
    }

    function l(e, o, n) {
        var t = o.data;
        if (j)try {
            j.send(t), n && n({errMsg: "sendSocketMessage:ok"})
        } catch (r) {
    ...
    var I, W = __wxConfig.apphash, C = __wxConfig.appid, R = __wxConfig.appname, O = !1, B = [], J = navigator.userAgent,
        // webViewVersion = parseInt(J.match(/webview\/(\d*)/)[1]),
        webViewVersion = 10,
        P = [], L = {}, F = Object.assign({
        domain: ["rapheal.sinaapp.com"],
        networkTimeout: {request: 3e4, connectSocket: 3e4, uploadFile: 3e4, downloadFile: 3e4}
    }, __wxConfig), G = 0, z = __wxConfig.appserviceConfig.AppserviceMaxDataSize;
    try {
    ...
    var j = null, K = {open: [], message: [], error: [], close: []}, U = {
        onAppLaunch: !1,
        onAppShow: !1,
        onAppTerminate: [],
        onAppRoute: [],
    ...
    }, X = {onMusicPlay: [], onMusicPause: [], onMusicEnd: [], onMusicError: []};
    WeixinJSBridge._subscribe = {}, WeixinJSBridge.subscribe = function (e, o) {
        ...
        B.push({
            ...
            appData: __wxAppData,
            sdkName: "send_app_data"
        }), e({eventName: o, data: n, sdkName: "publish", webviewIds: t})
        ...
        var n = B.filter(function (n) {
            var t = !e || (Array.isArray(e) ? e.includes(n.type) : n.type === e), r = !o || (Array.isArray(o) ? o.includes(n.eventName) : n.eventName === o);
            if (t && r)return n
        });
