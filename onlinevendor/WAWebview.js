...
!function (e) {
    if ("function" == typeof logxx && logxx("jsbridge start"), !e.WeixinJSBridge) {
        ...
        var n = e.hasOwnProperty("document"), i = !1, o = {}, r = 0, a = {}, s = "custom_event_", l = {};
        if (n) {
            var t = e.navigator.userAgent, c = t.indexOf("Android") != -1;
            i = !c
        }
        ...
        e.WeixinJSBridge = {invoke: h, invokeCallbackHandler: p, on: g, publish: f, subscribe: v, subscribeHandler: m}
    }
}(this);
var Reporter = function (e) {
    ...
    function r() {
        !f || f.length <= 0 || (o("reportKeyValue", {dataArray: f}), f = [])
    }

    function a() {
        !v || v.length <= 0 || (o("reportIDKey", {dataArray: v}), v = [])
    }

    function s() {
        !m || m.length <= 0 || (o("systemLog", {dataArray: m}), m = [])
    }
    ...
    var u = n(1), h = 1, p = 20, g = 50, f = [], v = [], m = [], b = "", A = 50, _ = 50, w = 20, y = 50, x = 500, C = 0, k = 0, E = 0, S = 0, T = {}, I = {}, B = 3, D = 10, P = 50;
    ...
    var N = "ios" === l(), F = ("devtools" === l(), function () {
    }), R = {
        surroundThirdByTryCatch: function (e, t) {
            return function () {
                ...
                try {
                    ...
                    o - i > 1e3 && R.speedReport({
                        ...
                        data: {},
                        timeMark: {startTime: i, endTime: o, nativeTime: 0}
                    })
                } catch (e) {
                    R.thirdErrorReport({error: e, extend: t})
                }
                return n
            }
        }, speedReport: function (e) {
            var t = e.key, n = e.data, i = e.timeMark, o = e.force;
            ...
            R.errorReport({key: "thirdScriptError", error: t, extend: n})
        }, errorReport: function (e) {
            var t = e.key, n = e.error, i = e.extend;
            if (u.ErrorType[t]) {
                var o = i ? n.message + " " + i : n.message, l = t + "\n" + o + "\n" + n.stack;
                if (console.error(l), "undefined" != typeof window && "undefined" != typeof window.__webviewId__ ? WeixinJSBridge.publish("WEBVIEW_ERROR_MSG", {
                    ...
                    I[c] || (I[c] = 0), I[c]++, "thirdScriptError" === t && I[c] > B || I[c] > D || (R.reportIDKey({key: t}), R.reportKeyValue({
                        key: "Error",
                        value: c
                    }), a(), r(), s())
                }
    ...
    }, t.KeyValueType = {Speed: "13544", Error: "13582"}, t.SpeedValueType = {
    ...
    function o(e, t) {
        if ("[object Error]" === Object.prototype.toString.apply(e)) {
            ...
            Reporter.errorReport({key: "webviewSDKScriptError", error: e, extend: t})
        }
    }

    var r = n(16), a = n(17), s = n(18), l = n(19);
    n(20);
    var c = {}, d = "devtools" === (0, l.getPlatform)(), u = function (e, t) {
        (0, r.publish)("INVOKE_METHOD", {name: e, args: t})
    }, h = {
        invoke: r.invoke,
        on: r.on,
        ...
        publishPageEvent: function (e, t) {
            (0, r.publish)("PAGE_EVENT", {eventName: e, data: t})
        },
    ...
    function a() {
        ...
        e[1] = function (e, n) {
            var i = e.data, o = e.options, r = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2], a = o && o.timestamp || 0, s = Date.now();
            "function" == typeof t && t(i, n), Reporter.speedReport({
                key: "appService2Webview",
                data: i || {},
                timeMark: {startTime: a, endTime: s, nativeTime: r.nativeTime}
            })
        }, n(function () {
    ...
    function s(e) {
        ...
        i(e, t, function (t) {
            ...
            var i = 0 === t.errMsg.indexOf(e + ":ok"), r = 0 === t.errMsg.indexOf(e + ":cancel"), a = 0 === t.errMsg.indexOf(e + ":fail");
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.invoke = i, t.on = o, t.publish = r, t.subscribe = a, t.invokeMethod = s, t.onMethod = l
}, function (e, t, n) {
    function i(e) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.insertContactButton = i, t.updateContactButton = o, t.removeContactButton = r, t.enterContact = a;
    var s = n(16)
}, function (e, t, n) {
    Object.defineProperty(t, "__esModule", {value: !0}), t.onAppEnterBackground = t.onAppEnterForeground = void 0;
    var i = n(16), o = [], r = [], a = function (e) {
        o.push(e)
    }, s = function (e) {
        r.push(e)
    };
    ...
    function a() {
        ...
        o.splice(0, n);
        var t = o.join("/"), r = e.length > 0 ? e.split("/") : [];
        r.splice(r.length - n - 1, n + 1);
        var s = r.concat(o), l = s.join("/");
        return l
    }

    function s(e) {
        var t = e.animates, n = e.option, i = void 0 === n ? {} : n, o = i.transformOrigin, a = i.transition;
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.getRealRoute = a, t.animationToStyle = s, t.getPlatform = l;
    ...
    var o = n(16), r = !1, a = ["log", "warn", "error", "info", "debug"];
    ...
    var i = n(1), o = n(2), r = n(3), a = n(4), s = n(6), l = n(12), c = n(11), d = n(5);
    ...
    var u = {renderingMode: "full", keepWhiteSpace: !1, parseTextContent: !0, throwGlobalError: !1};
    ...
    var i = n(1), o = Date.now(), r = function (e, t, n, i) {
        i = i || {};
        var r = i.originalEvent, a = !i.bubbles, s = !i.composed, l = i.extraFields || {}, c = !1, d = Date.now() - o, u = e.__wxElement || e;
        e === u.shadowRoot && (u = e);
        var h = function () {
            r && r.preventDefault()
        }, p = function () {
            c = !0
        }, g = {target: u, currentTarget: u, type: t, timeStamp: d, detail: n, preventDefault: h, stopPropagation: p};
        for (var f in l)g[f] = l[f];
        for (var v = function (e, t) {
            g.currentTarget = t;
            var n = e.call(t, [g]);
            n === !1 && (h(), c = !0)
        }, m = u.parentNode, b = u; b && (m === b && (m = b.parentNode), b.__wxEvents && b.__wxEvents[t] && v(b.__wxEvents[t], b), !a && !c);)if (b.__host) {
            if (s)break;
    ...
    var i = n(1), o = function () {
    };
    o.prototype = Object.create(Object.prototype, {constructor: {value: o, writable: !0, configurable: !0}});
    var r = ["created", "attached", "detached"], a = 1;
    o.create = function (e) {
        var t = String(a++), n = o.list[e.is || ""] = Object.create(o.prototype, {
            is: {value: e.is || ""},
            _id: {value: t}
        });
    ...
    var i = n(2), o = n(5), r = function () {
    };
    r.prototype = Object.create(Object.prototype, {constructor: {value: r, writable: !0, configurable: !0}});
    var a = null;
    ...
    var s = function (e) {
        ...
        if (e.__childObservers && !e.__childObservers.empty || e.__subtreeObserversCount) {
            var i = null;
            i = "add" === t ? {type: "childList", target: e, addedNodes: [n]} : {
                    type: "childList",
                    target: e,
                    removedNodes: [n]
        ...
        var l = null;
        if (t)if (t.__virtual) {
            var c = document.createDocumentFragment(), d = function (e) {
    ...
    o.prototype = Object.create(Object.prototype, {
        ...
        t = t || {};
        var n = 0, o = t.subtree ? this._cb : this._noSubtreeCb;
    ...
    var r = o._updateSubtreeCaches = function (e, t) {
        ...
        var n = e.childNodes;
        if (n)for (var i = 0; i < n.length; i++)r(n[i], t)
    };
    ...
    var o = n(1), r = n(2), a = n(7), s = n(3), l = n(4), c = n(5), d = r.addListenerToElement, u = function () {
    };
    ...
    u.register = function (e) {
        var t = e.options || {}, n = {is: {value: e.is || ""}}, i = s.create(e), r = Object.create(null);
        Object.keys(i.properties).forEach(function (e) {
            var t = i.properties[e];
            t !== String && t !== Number && t !== Boolean && t !== Object && t !== Array || (t = {type: t}), void 0 === t.value && (t.type === String ? t.value = "" : t.type === Number ? t.value = 0 : t.type === Boolean ? t.value = !1 : t.type === Array ? t.value = [] : t.value = null), r[e] = {
                type: t.type,
                value: t.value,
        ...
        d.__propPublic = f;
        var _ = i.getAllListeners(), w = Object.create(null);
        for (var y in _) {
            for (var x = _[y], C = [], k = 0; k < x.length; k++)C.push(i.methods[x[k]]);
            w[y] = C
        }
        u.list[i.is] = {proto: d, template: A, defaultValuesJSON: JSON.stringify(v), innerEvents: w}
    }, u.create = function (e) {
        e = e ? e.toLowerCase() : "virtual";
        var t = document.createElement(e), n = u.list[e] || u.list[""], i = Object.create(n.proto);
        ...
        var r = n.innerEvents;
        for (var a in r) {
            var s = a.split(".", 2), c = s[s.length - 1], h = i, p = !0;
            if (2 === s.length && "" !== s[0] && (p = !1, "this" !== s[0] && (h = i.$[s[0]])), h)for (var g = r[a], f = 0; f < g.length; f++)p ? d(h.shadowRoot, c, g[f].bind(i)) : d(h, c, g[f].bind(i))
        }
    ...
    function r(e, t, n, i, o) {
        for (var a = null, s = 0, l = null, p = 0; p < e.length; p++) {
            var g = e[p];
            if (void 0 === g.name) a = h.create(g.text), g.exp && o.add(g.exp, a.__domElement, "textContent", w), c.appendChild(t, a); else {
                var f = g.attrs;
                if ("virtual" === g.name) a = u.create(g.virtual); else if (g.custom)for (a = v.create(g.name), s = 0; s < f.length; s++)l = f[s], l.updater ? l.updater(a, l.name, l.value) : a.__behavior.properties[l.name].type === Boolean ? a[l.name] = !0 : a[l.name] = l.value, l.exp && o.add(l.exp, a, l.name, l.updater); else for (a = d.wrap(document.importNode(g.prerendered, !1)), s = 0; s < f.length; s++)l = f[s], o.add(l.exp, a.__domElement, l.name, l.updater);
    ...
    function a(e, t, n, i, o) {
        for (var r = null, s = 0, l = null, c = 0; c < e.length; c++) {
            var d = e[c];
            if (void 0 === d.name) r = document.createTextNode(d.text), d.exp && o.add(d.exp, r, "textContent", w), t.appendChild(r); else {
                var u = d.attrs;
    ...
    var s = n(8), l = n(9), c = n(4), d = n(10), u = n(11), h = n(12), p = String.fromCharCode(36), g = function () {
    };
    g.prototype = Object.create(Object.prototype, {constructor: {value: g, writable: !0, configurable: !0}});
    var f = function () {
    };
    ...
    var b = function (e, t, n) {
        ...
        e.style[t] = n
    }, k = {name: "virtual", virtual: "slot", slot: "", attrs: [], children: []}, E = {
        name: "virtual",
        slot: "",
        attrs: [],
    ...
    g.create = function (e, t, n, r) {
        var a = m(), s = r.renderingMode || a.renderingMode, c = k;
        "native" === s && (c = E);
        var d = o(e.attributes), u = {
        ...
        var f = !1, v = function (e, o, r, a) {
            for (var d = void 0, u = 0; u < o.length; u++) {
                var h = o[u], g = r.concat(e.length);
                if (8 !== h.nodeType)if (3 !== h.nodeType)if ("WX-CONTENT" !== h.tagName && "SLOT" !== h.tagName) {
                    var m = h.tagName.indexOf("-") >= 0 && "native" !== s, k = null;
                    m || (k = document.createElement(h.tagName));
                    var E = "", S = h.attributes, T = [];
                    if (S) {
                        for (var I = {}, B = 0; B < S.length; B++) {
                            var D = S[B];
                            if ("id" === D.name) E = D.value; else if ("parse-text-content" === D.name) I.parseTextContent = !0; else if ("keep-white-space" === D.name) I.keepWhiteSpace = !0; else {
                                d = void 0;
                                var P = void 0, N = D.name;
                                ...
                                m || (P || y)(k, N, F), (m || d) && T.push({name: N, value: F, updater: P, exp: d})
                            }
                        }
                        var R = {
        ...
        var e = Object.create(f.prototype), t = Object.create(null), n = Object.create(null), i = s.create(), o = document.createDocumentFragment();
    ...
    o.prototype = Object.create(Object.prototype, {
        ...
        for (var n = Object.create(o.prototype), i = e.split(/\{\{(.*?)\}\}/g), r = [], a = 0; a < i.length; a++)if (a % 2) {
            var s = i[a].match(/^(!?)([-_a-zA-Z0-9]+)(?:\((([-_a-zA-Z0-9]+)(,[-_a-zA-Z0-9]+)*)\))?$/) || [!1, ""], l = null;
            if (s[3]) {
                l = s[3].split(",");
                for (var c = 0; c < l.length; c++)r.indexOf(l[c]) < 0 && r.push(l[c])
            } else r.indexOf(s[2]) < 0 && r.push(s[2]);
            i[a] = {not: !!s[1], prop: s[2], callee: l}
        }
    ...
    o.prototype.calculate = function (e, t) {
        var n = this._slices, i = null, o = "";
        if (this.isSingleVariable) i = n[1], o = r(e, t, this._methods, i); else for (var a = 0; a < n.length; a++)i = n[a], o += a % 2 ? r(e, t, this._methods, i) : i;
        return o
    }, e.exports = o
}, function (e, t, n) {
    var i = n(4), o = function () {
    };
...
!function (e) {
    ...
    }, i = 10, o = 350, r = 50, a = function (e, t) {
    ...
    }, s = !1, l = 0, c = 0, d = 0, u = 0, h = null, p = !1, g = function (e) {
    ...
    var A = {}, _ = function (e) {
        if (A.selector)for (var t = A.selector, n = e.target; n;) {
        ...
        for (var i = 0; i < A.data.length; i++) {
            var o = A.data[i];
            if (o.element === n) {
                var r = {eventID: o.eventID, page: o.page, element: o.element, action: o.action, time: Date.now()};
                0 === n.indexOf(".") && (r.index = Array.prototype.indexOf.call(document.body.querySelectorAll(o.element), e)), t(function () {
                    WeixinJSBridge.publish("analyticsReport", {data: r})
                });
                break
            }
        }
    ...
    hoverTouchStart: function (e) {
        var t = this;
        if (this.__touch = !0, "none" == this.hoverStyle || "none" == this.hoverClass || this.disabled); else {
    ...
    valueChange: function (e, t) {
        this._relatedGroup && this._relatedGroup.triggerEvent("wxItemValueChanged", {item: this, newVal: e, oldVal: t})
    },
    ...
    _getBox: function () {
        var e = this.$$.getBoundingClientRect(), t = {
    ...
    attached: function () {
        var e = this, t = this.$.player, n = this, i = {};
        ...
        t.onerror = function (e) {
            ...
            e.stopPropagation(), n._publish("ratechange", {playbackRate: t.playbackRate})
        });
        var r = 0;
    ...
    is: "wx-touchtrack", touchtrack: function (e, t) {
        var n = this, i = 0, o = 0, r = 0, a = 0, s = function (e, s, l, c) {
            var d = n[t].call(n, {
                target: e.target,
                currentTarget: e.currentTarget,
                preventDefault: e.preventDefault,
                stopPropagation: e.stopPropagation,
                detail: {state: s, x: l, y: c, dx: l - i, dy: c - o, ddx: l - r, ddy: c - a}
            });
            if (d === !1)return !1
        }, l = null;
    ...
    properties: {
        ...
        controls: {type: Boolean, value: !1, observer: "controlsChanged", public: !0},
    ...
    actionChanged: function (e, t) {
        if (e) {
            ...
            if (null != (i = /^set([a-z|A-Z]*)/.exec(n))) {
                var o = i[1], r = e.data;
                o = o[0].toLowerCase() + o.slice(1), "playbackRate" == o || "currentTime" == o ? this.$.player[o] = r : "src" === o ? this.srcChanged(r) : this.triggerEvent("error", {errMsg: n + " is not an action"})
            } else if ("play" == n || "pause" == n) {
                if (this.isBackground === !0 && "play" === n)return;
                this.$.fakebutton.click()
            } else this.triggerEvent("error", {errMsg: n + " is not an action"});
            this.action = null
        }
    },
    attached: function () {
        var e = this, t = this.$.player, n = this;
        this.$.button.onclick = function (e) {
            e.stopPropagation(), n.action = {method: n._buttonType}
            ...
            e.action = t
        }), WeixinJSBridge.publish("audioInsert", {audioId: this.id}), wx.onAppEnterBackground(function (t) {
    ...
    listeners: {"this.formSubmit": "submitHandler", "this.formReset": "resetHandler"},
    resetDfs: function (e) {
    ...
    submitHandler: function (e) {
        ...
        return this._data = Object.create(null), this.asyncDfs(this, function () {
            t.reportSubmit ? t._isDevTools() ? t.triggerEvent("submit", {
                        ...
                        t.triggerEvent("submit", {value: t._data, formId: e.formId, target: n})
                    }) : t.triggerEvent("submit", {value: t._data, target: n})
        }), !1
    },
    resetHandler: function (e) {
        ...
        return this._data = Object.create(null), this.resetDfs(this), this.triggerEvent("reset", {target: t}), !1
    }
}), window.exparser.registerElement({
    is: "wx-icon",
    ...
    is: "wx-image", template: '<div id="div"></div>', behaviors: ["wx-base"],
    properties: {
        src: {type: String, observer: "srcChanged", public: !0},
...
window.exparser.registerElement({
    ...
    properties: _defineProperty({
        sessionFrom: {type: String, value: "", public: !0},
        type: {type: String, value: "default-dark", public: !0, observer: "typeChanged"},
        ...
        if (this._isMobile(), 1) {
            ...
            t = buttonTypes[this.type] ? buttonTypes[this.type] : buttonTypes["default-dark"], this.$.wrapper.style.backgroundImage = "url('" + t + "')", this.$.wrapper.addEventListener("click", function () {
                e._isMobile() ? wx.enterContact({
                        sessionFrom: e.sessionFrom, complete: function (e) {
                            console.log(e)
                        }
    ...
    _getBox: function () {
        var e = this.$.wrapper.getBoundingClientRect(), t = this.size;
        "number" != typeof t && (t = MIN_SIZE), t = t > MAX_SIZE ? MAX_SIZE : t, t = t < MIN_SIZE ? MIN_SIZE : t;
        var n = {left: e.left + window.scrollX, top: e.top + window.scrollY, width: t, height: t};
        return n
    },
    ...
    /wechatdevtools/.test(window.navigator.userAgent.toLowerCase()) && window.exparser.registerElement({
        ...
        attached: function () {
            ...
            this._checkPlaceholderStyle(this.value), this._attached = !0, this._value = this.value, this.updateInput(), window.__onAppRouteDone && this._couldFocus(this.autoFocus || this.focus), this.__routeDoneId = exparser.addListenerToElement(document, "routeDone", function () {
                ...
                if (e._keyboardShow) {
                    var n = t.detail.value, i = t.detail.cursor;
        ...
        _inputKeyUp: function (e) {
            if (13 == e.keyCode)return this.triggerEvent("confirm", {value: this.value}), void this.$.input.blur()
        },
        ...
        updateInput: function () {
            var e = window.getComputedStyle(this.$$), t = this.$$.getBoundingClientRect(), n = (["Left", "Right"].map(function (t) {
...
!function () {
    /wechatdevtools/.test(window.navigator.userAgent.toLowerCase()) || window.exparser.registerElement({
        ...
        properties: {
            ...
            disabled: {type: Boolean, value: !1, public: !0},
            bindinput: {type: String, value: "", public: !0},
            cursorSpacing: {type: Number, value: 0, public: !0}
        },
        ...
        onKeyboardConfirm: function (e) {
            this._keyboardShow && e.detail.inputId == this._inputId && (this._value = e.detail.value, this.triggerEvent("confirm", {value: this._value}))
        },
        onKeyboardComplete: function () {
            this.__formResetCallback && (this.value = "", this.__formResetCallback = void 0), "function" == typeof this.__formCallback && (this.__formCallback(this._value), this.__formCallback = void 0), this.triggerEvent("change", {value: this._value}), this.triggerEvent("blur", {value: this._value}), this._resetInputState()
        },
        getComputedStyle: function () {
            var e = this.$$, t = window.getComputedStyle(e), n = e.getBoundingClientRect(), i = ["Left", "Right"].map(function (e) {
        ...
        getPlaceholderStyle: function () {
            var e = this.$.placeholder, t = window.getComputedStyle(e), n = parseInt(t.fontWeight);
        ...
        _inputFocus: function (e) {
            return !this.disabled && (this.triggerEvent("focus", {value: this.value}), !this._keyboardShow && (this._showNativeInput(), !1))
        },
        defaultValueChange: function (e, t) {
        ...
        _getHexColor: function (e) {
            ...
            try {
                var t, n, i = function () {
                    ...
                    }), t.length > 3 && (n = parseFloat(t.slice(3).join(".")), 0 == n ? i.push("00") : n >= 1 ? i.push("ff") : (n = parseInt(255 * n).toString(16), n = n.length > 1 ? n : "0" + n, i.push(n))), {v: "#" + i.join("")}
                }();
        ...
        checkLineHeight: function () {
            ...
            window.requestAnimationFrame(function () {
                var t = window.getComputedStyle(e.$$), n = e.$$.getBoundingClientRect(), i = (["Left", "Right"].map(function (e) {
...
var touchEventNames = ["touchstart", "touchmove", "touchend", "touchcancel", "longtap"], touchEventMap = {
    touchstart: "onTouchStart",
    touchmove: "onTouchMove",
    touchend: "onTouchEnd",
    touchcancel: "onTouchCancel",
    longtap: "onLongPress"
}, LONG_PRESS_TIME_THRESHOLD = 300, LONG_PRESS_DISTANCE_THRESHOLD = 5, format = function (e, t, n, i) {
    ...
    return [].concat(_toConsumableArray(e)).map(function (e) {
        return {identifier: e.identifier, x: e.pageX - t._box.left, y: e.pageY - t._box.top}
    })
...
window.exparser.registerElement({
    ...
    properties: {
        ...
        disableScroll: {type: Boolean, value: !1, public: !0, observer: "disableScrollChanged"}
    },
    ...
    attached: function () {
        var e = this, t = (this.$.canvas, this);
        if (this._images = {}, this._box = this._getBox(), this.$.canvas.width = this.$$.offsetWidth, this.$.canvas.height = this.$$.offsetHeight, !this.canvasId)return this.triggerEvent("error", {errMsg: "canvas-id attribute is undefined"}), this._isError = !0, void(this.$$.style.display = "none");
        window.__canvasNumbers__ = window.__canvasNumbers__ || {};
        var n = window.__webviewId__ + "canvas" + this.canvasId;
        return window.__canvasNumbers__.hasOwnProperty(n) ? (this.triggerEvent("error", {errMsg: "canvas-id " + t.canvasId + " in this page has already existed"}), this._isError = !0, void(this.$$.style.display = "none")) : (window.__canvasNumber__ = window.__canvasNumber__ || 1e5, window.__canvasNumbers__[n] = window.__canvasNumber__ + __webviewId__, window.__canvasNumber__ += 1e5, this._canvasNumber = window.__canvasNumbers__[n], void(this._isMobile() ? !function () {
                    t._isReady = !1;
                    var n = {
                        target: {
                            target: e.$$.id,
                    ...
                    WeixinJSBridge.publish("onCanvasToDataUrl_" + e._canvasNumber, {dataUrl: t})
    ...
    detached: function () {
        ...
        delete window.__canvasNumbers__[e], this._isMobile() && WeixinJSBridge.invoke("removeCanvas", {canvasId: this._canvasNumber}, function (e) {
    ...
    addTouchEventForWebview: function () {
        ...
        touchEventNames.forEach(function (t) {
            e.$$.addEventListener(t, function (n) {
                var i = getCanvasTouches.call(e, n.touches), o = getCanvasTouches.call(e, n.changedTouches);
                        ...
                        e._touchInfo[t.identifier] = {}, e._touchInfo[t.identifier].x = t.x, e._touchInfo[t.identifier].y = t.y, e._touchInfo[t.identifier].timeStamp = n.timeStamp, e._touchInfo[t.identifier].handler = setTimeout(function () {
                            if (e._touchInfo.hasOwnProperty(t.identifier)) {
                                ...
                                for (var r in e._touchInfo) {
                                    var a = {identifier: r, x: e._touchInfo[r].x, y: e._touchInfo[r].y};
    ...
    actionsChanged: function (e) {
        ...
        if (!this._isMobile() && e) {
            var n = this.$.canvas, i = n.getContext("2d");
            t === !1 && (i.fillStyle = "#000000", i.strokeStyle = "#000000", i.shadowColor = "#000000", i.shadowBlur = 0, i.shadowOffsetX = 0, i.shadowOffsetY = 0, i.setTransform(1, 0, 0, 1, 0, 0), i.clearRect(0, 0, n.width, n.height)), e.forEach(function (e) {
                var t = this, n = e.method, o = e.data;
                if (/^set/.test(n)) {
                    var r = n[3].toLowerCase() + n.slice(4), a = void 0;
                    if ("fillStyle" === r || "strokeStyle" === r) {
                        if ("normal" === o[0]) a = resolveColor(o[1]); else if ("linear" === o[0]) {
                            var a = i.createLinearGradient.apply(i, o[1]);
                            o[2].forEach(function (e) {
                                var t = e[0], n = resolveColor(e[1]);
                                a.addColorStop(t, n)
                            })
                        } else if ("radial" === o[0]) {
                            var s = o[1][0], l = o[1][1], c = o[1][2], d = [s, l, 0, s, l, c], a = i.createRadialGradient.apply(i, d);
                            o[2].forEach(function (e) {
                                var t = e[0], n = resolveColor(e[1]);
                                a.addColorStop(t, n)
                            })
                        ...
                        i[r] = a
                    } else if ("globalAlpha" === r) i[r] = o[0] / 255; else if ("shadow" === r) {
                        ...
                        i[e.method].apply(i, e.data)
                                ...
                                var e = _toArray(o), n = e[0], r = e.slice(1);
...
!function () {
    ...
    properties: {
        latitude: {type: Number, public: !0, observer: "latitudeChanged", value: 39.92},
        longitude: {type: Number, public: !0, observer: "longitudeChanged", value: 116.46},
        scale: {type: Number, public: !0, observer: "scaleChanged", scale: 16},
        markers: {type: Array, value: [], public: !0, observer: "markersChanged"},
        covers: {type: Array, value: [], public: !0, observer: "coversChanged"},
        includePoints: {type: Array, value: [], public: !0, observer: "pointsChanged"},
        polyline: {type: Array, value: [], public: !0, observer: "linesChanged"},
        circles: {type: Array, value: [], public: !0, observer: "circlesChanged"},
        controls: {type: Array, value: [], public: !0, observer: "controlsChanged"},
        showLocation: {type: Boolean, value: !1, public: !0, observer: "showLocationChanged"},
        bindmarkertap: {type: String, value: "", public: !0},
        bindcontroltap: {type: String, value: "", public: !0},
        bindregionchange: {type: String, value: "", public: !0},
        bindtap: {type: String, value: "", public: !0},
        _mapId: {type: Number}
    },
    ...
    _transformColor: function (e) {
        ...
        var t = Number("0x" + e.substr(0, 2)), n = Number("0x" + e.substr(2, 2)), i = Number("0x" + e.substr(4, 2)), o = e.substr(6, 2) ? Number("0x" + e.substr(6, 2)) / 255 : 1;
    ...
    _insertNativeMap: function () {
        ...
        this._canInvokeNewFeature || (t.markers = this.markers || []), WeixinJSBridge.invoke("insertMap", t, function (t) {
            /ok/.test(t.errMsg) ? (e._mapId = t.mapId, e._ready(), e._canInvokeNewFeature && WeixinJSBridge.publish("mapInsert", {
                    ...
                    bindtap: e.bindtap
                }), e.__pageReRenderCallback = e._pageReRenderCallback.bind(e), document.addEventListener("pageReRender", e.__pageReRenderCallback)) : e.triggerEvent("error", {errMsg: t.errMsg})
        })
    },
    _insertIframeMap: function () {
        var e = this, t = this._map = new qq.maps.Map(this.$.map, {
            zoom: this.scale,
        ...
        qq.maps.event.addListener(t, "click", function () {
            ...
            e.bindregionchange && !n && (wx.publishPageEvent(e.bindregionchange, {type: "begin"}), n = !0, i = !1)
        }), qq.maps.event.addListener(t, "dragend", function () {
            n && (n = !1, i = !0)
        }), qq.maps.event.addListener(t, "bounds_changed", function () {
            e.bindregionchange && i && (wx.publishPageEvent(e.bindregionchange, {type: "end"}), i = !1)
        });
        var o = qq.maps.event.addListener(t, "tilesloaded", function () {
            e._mapId = __map_jssdk_id++, e._ready(), WeixinJSBridge.subscribe("doMapAction" + e._mapId, function (t) {
                if (e._map && e._mapId === t.data.mapId)if ("getMapCenterLocation" === t.data.method) {
        ...
        r.prototype = new qq.maps.Overlay, r.prototype.construct = function () {
            ...
            var e = this.getProjection(), t = e.fromLatLngToDivPixel(this.position), n = this.div.style;
    ...
    scaleChanged: function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 16, t = arguments[1];
        if (e)return this._isReady ? void(this._isMobile() ? this._update({
                    centerLatitude: this.latitude,
                    centerLongitude: this.longitude,
                    scale: e
    ...
    coversChanged: function () {
        ...
        return this._isReady ? void(this._isMobile() ? wx.getCurrentRoute({
                    ...
                    var n = new qq.maps.Marker({position: new qq.maps.LatLng(t.latitude, t.longitude), map: e._map});
        ...
        return this._isReady ? void(this._isMobile() ? wx.getCurrentRoute({
                    success: function (n) {
                        ...
                        e._canInvokeNewFeature ? WeixinJSBridge.invoke("addMapMarkers", {
                            ...
                            }) : e._update({centerLatitude: e.latitude, centerLongitude: e.longitude, markers: i})
                    }
                    ...
                    return t.iconPath && (Number(t.width) && Number(t.height) ? n.setIcon(new qq.maps.MarkerImage(t.iconPath, new qq.maps.Size(t.width, t.height), new qq.maps.Point(0, 0), new qq.maps.Point(t.width / 2, t.height), new qq.maps.Size(t.width, t.height))) : n.setIcon(new qq.maps.MarkerImage(t.iconPath))), (t.title || t.name) && n.setTitle(t.title || t.name), e.bindmarkertap && "undefined" != typeof t.id && qq.maps.event.addListener(n, "click", function (n) {
                        var i = n.event;
                        i instanceof TouchEvent ? "touchend" === i.type && wx.publishPageEvent(e.bindmarkertap, {markerId: t.id}) : wx.publishPageEvent(e.bindmarkertap, {markerId: t.id})
                    }), n
    ...
    controlsChanged: function () {
        ...
        return this._isReady ? void(this._isMobile() ? this._canInvokeNewFeature && wx.getCurrentRoute({
                    success: function (n) {
                        ...
                        WeixinJSBridge.invoke("addMapControls", {mapId: e._mapId, controls: i}, function (e) {
                        })
                    }
                }) : !function () {
                    ...
                    t.forEach(function (t) {
                        ...
                        i.style.position = "absolute", i.style.left = (t.position && t.position.left || 0) + "px", i.style.top = (t.position && t.position.top || 0) + "px", i.style.width = (t.position && t.position.width || "") + "px", i.style.height = (t.position && t.position.height || "") + "px", i.style.zIndex = 9999, i.src = t.iconPath, t.clickable && "undefined" != typeof t.id && (i.onclick = function () {
                            wx.publishPageEvent(e.bindcontroltap, {controlId: t.id})
    ...
    showLocationChanged: function () {
        var e = this, t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], n = arguments[1];
        return this._isReady ? void(this._isMobile() ? this._update({showLocation: t}) : (this._posOverlay && (this._posOverlay.setMap(null), this._posOverlay = null), t && WeixinJSBridge.invoke("private_geolocation", {}, function (t) {
                    try {
                        t = JSON.parse(t)
                    } catch (e) {
                        t = {}
    ...
    behaviors: ["wx-base", "wx-data-component"],
    properties: {
        range: {type: Array, value: [], public: !0},
        value: {type: String, value: "", public: !0},
    ...
    showSelector: function (e) {
        ...
        if (!this.disabled) {
            ...
            var i = [];
            if (this.rangeKey)for (var o = 0; o < this.range.length; o++) {
                var r = this.range[o];
                i.push(r[this.rangeKey] + "")
            } else for (var o = 0; o < this.range.length; o++)i.push(this.range[o] + "");
            WeixinJSBridge.invoke("showPickerView", {
                array: i,
                current: n,
                style: this.getCustomerStyle()
            }, function (e) {
                /:ok/.test(e.errMsg) && (t.value = e.index, t.triggerEvent("change", {value: t.value})), t.resetPickerState(), t.formGetDataCallback()
            }), this.__pickerShow = !0
        }
    },
    showDatePickerView: function () {
        ...
        this.disabled || (WeixinJSBridge.invoke("showDatePickerView", {
            ...
            /:ok/.test(t.errMsg) && (e.value = t.value, e.triggerEvent("change", {value: e.value})), e.resetPickerState(), e.formGetDataCallback()
        }), this.__pickerShow = !0)
    },
    ...
    properties: {
        ...
        strokeWidth: {type: Number, value: 6, public: !0},
        color: {type: String, value: "#09BB07", public: !0},
        active: {type: Boolean, value: !1, public: !0, observer: "activeAnimation"}
    },
    ...
    navigateTo: function () {
        ...
        if (this.redirect)return void wx.redirectTo({url: this.url});
        switch (this.openType) {
            case"navigate":
                return void wx.navigateTo({url: this.url});
            case"redirect":
    ...
    behaviors: ["wx-base", "wx-data-component"],
    properties: {
        value: {type: Array, value: [], public: !0, observer: "_valueChanged"},
        indicatorStyle: {type: String, value: "", public: !0}
    },
    listeners: {"this.wxPickerColumnValueChanged": "_columnValueChanged"},
    attached: function () {
        this._initColumns()
    },
    _initColumns: function () {
        var e = this, t = this._columns = [], n = function e(n) {
    ...
    function e(e, t, n) {
        ...
        return i(r, e, t, n), {cancel: o.bind(null, r), model: e}
    }
    ...
    o.prototype._solve = function (e, t) {
        ...
        return [{
            ...
            min: 100,
            max: 1e3
        }, {label: "Damping", read: this.damping.bind(this), write: t.bind(this, this), min: 1, max: 500}]
    ...
    a.prototype.onTouchStart = function () {
        ...
        var e = this._position, t = "translateY(" + e + "px)";
        ...
        var e = this._itemHeight, t = this._position % e, n = Math.abs(t) > 17 ? this._position - (e - Math.abs(t)) : this._position - t;
        ...
        _init: function () {
            ...
            this._touchInfo = {
                ...
                t !== e._current && (e._current = t, e.triggerEvent("wxPickerColumnValueChanged", {idx: t}, {bubbles: !0}))
        ...
        _findDelta: function (e) {
            ...
            if ("touchmove" != e.type && "touchend" != e.type)return {x: e.screenX - t.x, y: e.screenY - t.y};
            for (var n = e.changedTouches || e.touches, i = 0; i < n.length; i++)if (n[i].identifier == t.trackingID)return {
                x: n[i].pageX - t.x,
                y: n[i].pageY - t.y
            };
            return null
        ...
        _handleTouchEnd: function (e) {
            ...
            if (t.trackingID != -1) {
                ...
                if (n) {
                    ...
                    var o = t.historyTime.length, r = {x: 0, y: 0};
                    if (o > 2)for (var a = t.historyTime.length - 1, s = t.historyTime[a], l = t.historyX[a], c = t.historyY[a]; a > 0;) {
                        a--;
                        var d = t.historyTime[a], u = s - d;
                        if (u > 30 && u < 50) {
    ...
    var e = 1, t = null, n = [], i = function (i, o) {
        var r = e++;
        n.push({id: r, self: i, func: o, frames: 2});
        var a = function e() {
            t = null;
        ...
        for (var t = 0; t < n.length; t++)if (n[t].id === e)return void n.splice(t, 1)
    };
    window.exparser.registerElement({
        is: "wx-swiper-item",
        template: "\n    <slot></slot>\n  ",
        properties: {},
        listeners: {"this.wxSwiperItemChanged": "_invalidChild"},
        behaviors: ["wx-base"],
        _invalidChild: function (e) {
            if (e.target !== this)return !1
        },
        attached: function () {
            this._pendingTimeoutId = 0, this._pendingTransform = "", this._relatedSwiper = null, this.triggerEvent("wxSwiperItemChanged", void 0, {bubbles: !0})
        },
        detached: function () {
    ...
    properties: {
        checked: {type: Boolean, value: !1, public: !0},
        type: {type: String, value: "switch", public: !0},
        color: {type: String, value: "#04BE02", public: !0}
    },
    behaviors: ["wx-base", "wx-label-target", "wx-disabled", "wx-data-component"],
    listeners: {"switchInput.tap": "onInputChange", "checkboxInput.tap": "onInputChange"},
    ...
    onInputChange: function (e) {
        return this.checked = !this.checked, this.disabled ? void(this.checked = !this.checked) : void this.triggerEvent("change", {value: this.checked})
    },
    isSwitch: function (e) {
        return "checkbox" !== e
    },
    ...
    properties: {
        scrollX: {type: Boolean, value: !1, public: !0, observer: "_scrollXChanged"},
        scrollY: {type: Boolean, value: !1, public: !0, observer: "_scrollYChanged"},
        upperThreshold: {type: Number, value: 50, public: !0},
        lowerThreshold: {type: Number, value: 50, public: !0},
        scrollTop: {type: Number, coerce: "_scrollTopChanged", public: !0},
        scrollLeft: {type: Number, coerce: "_scrollLeftChanged", public: !0},
        scrollIntoView: {type: String, coerce: "_srollIntoViewChanged", public: !0}
    },
    created: function () {
    ...
    attached: function () {
        ...
        this._scrollTopChanged(this.scrollTop), this._scrollLeftChanged(this.scrollLeft), this._srollIntoViewChanged(this.scrollIntoView), this.__handleScroll = function (t) {
            ...
            e._checkBounce();
            var n = t.touches[0].pageY, i = e.$.main;
            ...
            e.__touchStartY = t.touches[0].pageY, WeixinJSBridge.invoke("disableScrollBounce", {disable: !0}, function () {
            });
            var n = e.$.main;
            ...
            WeixinJSBridge.invoke("disableScrollBounce", {disable: !1}, function () {
            })
    ...
    _handleScroll: function (e) {
        this._bounce || (clearTimeout(this._timeout), this._timeout = setTimeout(function () {
            ...
            if (this.triggerEvent("scroll", {
                ...
                e.scrollTop <= this.upperThreshold && t && this.triggerEvent("scrolltoupper", {direction: "top"}), e.scrollTop + e.offsetHeight + this.lowerThreshold >= e.scrollHeight && n && this.triggerEvent("scrolltolower", {direction: "bottom"})
            }
            if (this.scrollX) {
                var i = this._lastScrollLeft - e.scrollLeft > 0, o = this._lastScrollLeft - e.scrollLeft < 0;
                e.scrollLeft <= this.upperThreshold && i && this.triggerEvent("scrolltoupper", {direction: "left"}), e.scrollLeft + e.offsetWidth + this.lowerThreshold >= e.scrollWidth && o && this.triggerEvent("scrolltolower", {direction: "right"})
            }
    ...
    properties: {
        ...
        hidden: {type: Boolean, value: !1, public: !0, observer: "hiddenChange"},
        duration: {type: Number, value: 1500, public: !0, observer: "durationChange"}
    },
    ...
    properties: {
        min: {type: Number, value: 0, public: !0, observer: "_revalicateRange"},
        max: {type: Number, value: 100, public: !0, observer: "_revalicateRange"},
        step: {type: Number, value: 1, public: !0},
        value: {type: Number, value: 0, public: !0, coerce: "_filterValue"},
    ...
    _onTrack: function (e) {
        if (!this.disabled)return "move" === e.detail.state ? (this._onUserChangedValue(e), !1) : void("end" === e.detail.state && this.triggerEvent("change", {value: this.value}))
    },
    _onTap: function (e) {
        this.disabled || (this._onUserChangedValue(e), this.triggerEvent("change", {value: this.value}))
    },
    resetFormData: function () {
        this.value = this.min
    }
    ...
    properties: {
        ...
        vertical: {type: Boolean, value: !1, observer: "_initSlides", public: !0},
        autoplay: {type: Boolean, value: !1, observer: "_autoplayChanged", public: !0},
        circular: {type: Boolean, value: !1, observer: "_initSlides", public: !0},
        interval: {type: Number, value: 5e3, public: !0, observer: "_autoplayChanged"},
    ...
    _initSlides: function () {
        if (this._attached) {
            ...
            var e = this._items = [], t = function t(n) {
                for (var i = 0; i < n.childNodes.length; i++) {
                    var o = n.childNodes[i];
    ...
    _updateViewport: function (e, t) {
        var n = this, i = this._viewport;
        this._viewport = e;
        var o = this._slideCount, r = function (r) {
            var a = (r % o + o) % o;
            n.circular && n._slideCount > 1 || (r = a);
            var s = !1;
            t && (i <= e ? i - 1 <= r && r <= e + 1 && (s = !0) : e - 1 <= r && r <= i + 1 && (s = !0)), s ? n._updateItemPos(a, r - e, r - i) : n._updateItemPos(a, r - e)
        };
        if (i < e)for (var a = Math.ceil(e), s = 0; s < o; s++)r(s + a - o + 1); else for (var l = Math.floor(e), c = 0; c < o; c++)r(c + l)
    },
    ...
    _gotoSlide: function (e, t) {
        if (this._slideCount) {
            if (this._updateDots(e), this.circular && this._slideCount > 1) {
                var n = Math.round(this._viewport), i = Math.floor(n / this._slideCount), o = i * this._slideCount + e;
    ...
    _currentSlideChanged: function (e, t) {
        this._gotoSlide(e, this._nextDirection || 0), this._nextDirection = 0, e !== t && this.triggerEvent("change", {current: this.current})
    },
    ...
    _handleTrackMove: function (e) {
        var t = this, n = this._contentTrackT;
        this._contentTrackT = Date.now();
        var i = this._slideCount, o = function (e) {
            return .5 - .25 / (e + .5)
        }, r = function (e, n) {
    ...
    _handleContentTrack: function (e) {
        ...
        if (this._userTracking) {
            ...
            if (!this._userDirectionChecked) {
                ...
                var t = Math.abs(e.detail.dx), n = Math.abs(e.detail.dy);
    ...
    /wechatdevtools/.test(window.navigator.userAgent.toLowerCase()) && window.exparser.registerElement({
        ...
        properties: {
            value: {type: String, value: "", public: !0, coerce: "defaultValueChange"},
            maxlength: {type: Number, value: 140, public: !0},
            placeholder: {type: String, value: "", public: !0},
            hidden: {type: Boolean, value: !1, public: !0},
            disabled: {type: Boolean, value: !1, public: !0},
            focus: {type: Number, value: 0, public: !0, coerce: "focusChanged"},
            autoFocus: {type: Boolean, value: !1, public: !0},
            placeholderClass: {type: String, value: "textarea-placeholder", public: !0},
            placeholderStyle: {type: String, value: "", public: !0},
            autoHeight: {type: Boolean, value: !1, public: !0, observer: "autoHeightChanged"},
            bindinput: {type: String, value: "", public: !0}
        },
        listeners: {
        ...
        getCurrentRows: function (e) {
            var t = window.getComputedStyle(this.$.compute), n = 1.2 * (parseFloat(t.fontSize) || 16);
        ...
        onTextAreaFocus: function (e) {
            this.triggerEvent("focus", {value: this.value})
        },
        onTextAreaBlur: function (e) {
            this.triggerEvent("blur", {value: this.value})
        },
        ...
        _getPlaceholderStyle: function (e) {
            var t = ["position:absolute"], n = ["font-size", "font-weight", "color"];
            try {
                var i = e.split(";");
                for (var o in i) {
                    var r = i[o].split(":");
        ...
        autoHeightChanged: function (e) {
            if (e) {
                var t = this.getCurrentRows(this.value), n = t.height < t.lineHeight ? t.lineHeight : t.height;
...
!function () {
    /wechatdevtools/.test(window.navigator.userAgent.toLowerCase()) || window.exparser.registerElement({
        ...
        properties: {
            ...
            disabled: {type: Boolean, value: !1, public: !0},
            hidden: {type: Boolean, value: !1, public: !0, observer: "hiddenChanged"},
            focus: {type: Boolean, value: !1, public: !0, observer: "focusChanged"},
            autoFocus: {type: Boolean, value: !1, public: !0},
            placeholderStyle: {type: String, value: "", public: !0},
            placeholderClass: {type: String, value: "textarea-placeholder", public: !0},
        ...
        removeTextArea: function () {
            this.__detached && this._inputId && WeixinJSBridge.invoke("removeTextArea", {inputId: this._inputId}, function (e) {
            })
        },
        ...
        couldFocus: function (e) {
            this._isReady && window.__onAppRouteDone && !this.disabled && e && WeixinJSBridge.invoke("showKeyboard", {inputId: this._inputId}, function (e) {
            })
        },
        ...
        onKeyboardConfirm: function (e) {
            e.detail.inputId === this._inputId && (this.value = e.detail.value, this.triggerEvent("confirm", {value: this.value}))
        },
        onKeyboardShow: function (e) {
            e.detail.inputId === this._inputId && (this._keyboardShow = !0, this.triggerEvent("focus", {value: this.value}))
        },
        onKeyboardComplete: function (e) {
            e.detail.inputId === this._inputId && (this.value = e.detail.value, this.__formResetCallback && (this.value = "",
                this.__formResetCallback = void 0), "function" == typeof this.__formCallback && this.__formCallback(this.value), this.triggerEvent("blur", {value: this.value}), this.resetInputState())
        },
        ...
        updateTextArea: function (e) {
            ...
            n && (n.inputId = this._inputId, WeixinJSBridge.invoke("updateTextArea", n, function (n) {
                if (/:ok/.test(n.errMsg))for (var i in e)t.args[i] = e[i]
            }))
        },
        ...
        defaultValueChange: function (e, t) {
            return this.maxlength > 0 && e.length > this.maxlength && (e = e.slice(0, this.maxlength)), this.value != e && (this.args && (this.args.value = void 0), this.updateTextArea({value: e})), e
        },
        formateEventTarget: function () {
            var e = {
                bindinput: this.bindinput,
...
"ios" !== wx.getPlatform() && window.exparser.registerElement({
    ...
    properties: {
        hidden: {type: Boolean, value: !1, public: !0, observer: "_hiddenChanged"},
        autoplay: {type: Boolean, value: !1, public: !0},
        danmuBtn: {type: Boolean, value: !1, public: !0, observer: "danmuBtnChanged"},
        enableDanmu: {type: Boolean, value: !1, observer: "enableDanmuChanged", public: !0},
        enableFullScreen: {type: Boolean, value: !1, public: !0},
        controls: {type: Boolean, value: !0, public: !0, observer: "controlsChanged"},
        danmuList: {type: Array, value: [], public: !0},
        objectFit: {type: String, value: "contain", public: !0, observer: "objectFitChanged"},
        duration: {type: Number, value: 0, public: !0, observer: "durationChanged"},
        _videoId: {type: Number},
        _isLockTimeUpdateProgress: {type: Boolean, value: !1},
        _rate: {type: Number, value: 0},
        _progressLeft: {type: Number, value: -22},
        _progressLength: {type: Number, value: 0},
        _barType: {type: String, value: "full"},
        _danmuStatus: {type: String, value: ""}
    },
    listeners: {"ball.touchstart": "onBallTouchStart"},
    _reset: function () {
    ...
    srcChanged: function (e, t) {
        if (!this._isError && e)if ("wechatdevtools" === wx.getPlatform()) {
    ...
    actionChanged: function (e, t) {
        if ("object" === ("undefined" == typeof e ? "undefined" : _typeof(e))) {
            var n = e.method, i = e.data;
            if ("play" === n) this.$.player.play(); else if ("pause" === n) this.$.player.pause(); else if ("seek" === n) this.$.player.currentTime = i[0], this._resetDanmu(); else if ("sendDanmu" === n) {
                var o = _slicedToArray(i, 2), r = o[0], a = o[1], s = parseInt(this.$.player.currentTime);
                this.danmuObject[s] ? this.danmuObject[s].push({
                        text: r,
                        color: a,
                        time: s
                    }) : this.danmuObject[s] = [{text: r, color: a, time: s}]
            }
        }
    },
    onPlay: function (e) {
        var t = this, n = document.querySelectorAll(".wx-video-danmu-item");
    ...
    attached: function () {
        ...
        WeixinJSBridge.publish("videoPlayerInsert", {
            ...
            return "number" == typeof t.time && t.time >= 0 && "string" == typeof t.text && t.text.length > 0 && (e[t.time] ? e[t.time].push({
                ...
                }) : e[t.time] = [{text: t.text, color: t.color || "#ffffff"}]), e
        }, {}), this.$.button.onclick = function (e) {
            ...
            e.stopPropagation(), "android" === wx.getPlatform() ? t.enableFullScreen = !0 : t.enableFullScreen = !t.enableFullScreen, t.enableFullScreen && t.$.player.webkitEnterFullscreen(), t.triggerEvent("togglefullscreen", {enable: t.enableFullScreen})
        }, this.$.danmuBtn.onclick = function (e) {
            e.stopPropagation(), t.enableDanmu = !t.enableDanmu, t.triggerEvent("toggledanmu", {enable: t.enableDanmu})
...
"ios" === wx.getPlatform() && window.exparser.registerElement({
    ...
    properties: {
        autoplay: {type: Boolean, value: !1, public: !0},
        bindplay: {type: String, value: "", public: !0},
        bindpause: {type: String, value: "", public: !0},
        bindended: {type: String, value: "", public: !0},
        bindtimeupdate: {type: String, value: "", public: !0},
        danmuBtn: {type: Boolean, value: !1, public: !0, observer: "danmuBtnChanged"},
        enableDanmu: {type: Boolean, value: !1, observer: "enableDanmuChanged", public: !0},
        enableFullScreen: {type: Boolean, value: !1, public: !0},
        controls: {type: Boolean, value: !0, public: !0, observer: "controlsChanged"},
        danmuList: {type: Array, value: [], public: !0},
        objectFit: {type: String, value: "contain", public: !0},
        duration: {type: Number, value: 0, public: !0},
        _videoId: {type: Number},
        _isLockTimeUpdateProgress: {type: Boolean, value: !1},
        _rate: {type: Number, value: 0},
        _progressLeft: {type: Number, value: -22},
    ...
    _update: function (e) {
        ...
        e.needEvent = Object.keys(n.handlers).length > 0, e.objectFit = this.objectFit, e.showBasicControls = this.controls, e.showDanmuBtn = this.danmuBtn, e.enableDanmu = this.enableDanmu, this.duration > 0 && (args.duration = duration), WeixinJSBridge.invoke("updateVideoPlayer", e, function (e) {
            /ok/.test(e.errMsg) || t._publish("error", {errMsg: e.errMsg})
        })
    },
    _updatePosition: function () {
    ...
    _hiddenChanged: function (e, t) {
        this._isiOS() ? (this.$$.style.display = e ? "none" : "", this._update({hide: e}, e ? "隐藏" : "显示")) : (this.$.player.pause(), this.$$.style.display = e ? "none" : "")
    },
    posterChanged: function (e, t) {
    ...
    srcChanged: function (e, t) {
        if (!this._isError && e) {
            ...
            if (this._isiOS()) /wxfile:\/\//.test(e) || /http:\/\//.test(e) || /https:\/\//.test(e) ? this._update({filePath: e}, "资源") : this._publish("error", {errMsg: "MEDIA_ERR_SRC_NOT_SUPPORTED"}); else if (this._isDevTools()) {
                this.$.player.src = e.replace("wxfile://", "http://wxfile.open.weixin.qq.com/");
                var n = this;
                setTimeout(function () {
                    n._reset()
    ...
    onPlay: function (e) {
        ...
        Array.prototype.forEach.apply(n, [function (e) {
            var n = 3 * (parseInt(getComputedStyle(e).left) + e.offsetWidth) / (e.offsetWidth + t.$$.offsetWidth);
            e.style.left = "-" + e.offsetWidth + "px", e.style.transitionDuration = n + "s", e.style.webkitTransitionDuration = n + "s"
        }]), this.bindplay && wx.publishPageEvent(this.bindplay, {type: "play"})
    },
    onPause: function (e) {
        var t = document.querySelectorAll(".wx-video-danmu-item");
        Array.prototype.forEach.apply(t, [function (e) {
            e.style.left = getComputedStyle(e).left
        }]), wx.publishPageEvent(this.bindpause, {type: "pause"})
    },
    onEnded: function (e) {
        wx.publishPageEvent(this.bindended, {type: "ended"})
    },
    _computeRate: function (e) {
        var t = this.$.progress.getBoundingClientRect().left, n = this.$.progress.offsetWidth, i = (e - t) / n;
        return i < 0 ? i = 0 : i > 1 && (i = 1), i
        ...
        if (this._isiOS()) {
            ...
            this.duration > 0 && (i.duration = this.duration), WeixinJSBridge.invoke("insertVideoPlayer", i, function (e) {
                /ok/.test(e.errMsg) ? (t._videoId = e.videoPlayerId, t._ready(), t.createdTimestamp = Date.now(), document.addEventListener("pageReRender", t._pageReRenderCallback.bind(t)), WeixinJSBridge.publish("videoPlayerInsert", {
                    ...
                    })) : (t._isError = !0, t.$$.style.display = "none", t._publish("error", {errMsg: e.errMsg}))
            })
            ...
            e.stopPropagation(), t.enableFullScreen = !t.enableFullScreen, t.enableFullScreen && t.$.player.webkitEnterFullscreen(), t.triggerEvent("togglefullscreen", {enable: t.enableFullScreen})
        }, this.$.danmuBtn.onclick = function (e) {
            e.stopPropagation(), t.enableDanmu = !t.enableDanmu, t.triggerEvent("toggledanmu", {enable: t.enableDanmu})
    ...
    onTimeUpdate: function (e) {
        ...
        void 0 !== i && i.length > 0 && i.forEach(function (e) {
            ...
            type: "timeupdate",
            detail: {currentTime: this.$.player.currentTime, duration: this.$.player.duration}
        })
    },
    detached: function () {
    ...
    function o(e, t, n, i) {
        Reporter.speedReport({key: e, timeMark: {startTime: t, endTime: n}, force: "reRenderTime" !== e, data: i})
    }

    Object.defineProperty(t, "__esModule", {value: !0}), t.reset = void 0;
    var r = n(1), a = i(r), s = n(11), l = i(s), c = n(12), d = i(c), u = n(14), h = n(2), p = n(15), g = n(16);
    (0, g.init)(), window.__mergeData__ = d.default.mergeData;
    var f = "__DOMReady", v = function (e, t, n, i, o, r) {
    ...
    }, _ = void 0, w = {}, y = {funcReady: !1, dataReady: !1, firstRender: !1}, x = [];
    window.__DOMTree__ = void 0;
    var C = {webviewStartTime: Date.now(), funcReady: 0};
    t.reset = function () {
    ...
    }(), a = n(2), s = n(4), l = n(6), c = n(11), d = i(c), u = (n(3), function () {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.getPageConfig = t.getDataType = t.uuid = t.transformRpx = t.getPrototype = t.isArray = t.isString = t.isUndefined = t.isVirtualText = t.isVirtualNode = t.isEmptyObject = t.isObject = void 0;
    ...
    }, navigator.userAgent.match("iPhone")), l = window.screen.width || 375, c = window.devicePixelRatio || 2, d = 1e-4, u = function (e) {
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        }, o = n(2), r = n(5), a = n(3), s = /^data-/, l = function (e) {
        ...
        e.dataset = e.dataset || {};
        for (var n in t) {
            var l = t[n], c = exparser.Component.hasProperty(e, n);
            ...
            void 0 === l ? u(e, n) : c ? a.INLINE_STYLE.indexOf(n) !== -1 ? e[n] = (0,
                            o.transformRpx)(l, !0) : e[n] = l : "bind" === n.slice(0, 4) ? d(e, n.slice(4), l) : "catch" === n.slice(0, 5) ? d(e, n.slice(5), l, !0) : "on" === n.slice(0, 2) ? d(e, n.slice(2), l) : a.ATTRIBUTE_NAME.indexOf(n) !== -1 || s.test(n) ? "style" === n ? !function () {
                                            var t = e.animationStyle || {}, i = t.transition, r = t.transform, a = t.transitionProperty, s = t.transformOrigin, c = {
                                                transition: i,
                                                transform: r,
                                        ...
                                        var t = function () {
                                            if (n < r) {
                                                var t = wx.animationToStyle(i[n]), a = t.transition, s = t.transitionProperty, l = t.transform, c = t.transformOrigin, d = t.style;
                                        ...
                                        }, n = 0, i = l.actions, r = l.actions.length;
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0});
    var n = {}, i = {dashToCamel: /-[a-z]/g, camelToDash: /([A-Z])/g};
    ...
    var o = n(7), r = i(o), a = n(8), s = i(a), l = n(2), c = n(10), d = n(3), u = (t.diff = function (e, t) {
        var n = {};
        return u(e, t, n, 0), new s.default(e, n)
    }, t.diffNode = function (e, t, n, i) {
        if (e !== t) {
            var o = n[i];
            if (null == t) o = g(o, new r.default(d.PATCH_TYPE.REMOVE, e)); else if ((0, l.isVirtualNode)(t))if ((0, l.isVirtualNode)(e))if (e.tagName === t.tagName && e.wxKey === t.wxKey)if ("virtual" === e.tagName && e.wxVkey !== t.wxVkey) o = g(o, new r.default(d.PATCH_TYPE.VNODE, e, t)); else {
                var a = p(t.props, t.newProps);
                a && (o = g(o, new r.default(d.PATCH_TYPE.PROPS, e, a))), o = h(e, t, n, o, i)
            } else o = g(o, new r.default(d.PATCH_TYPE.VNODE, e, t)); else o = g(o, new r.default(d.PATCH_TYPE.VNODE, e, t)); else {
    ...
    var o = function () {
        ...
        return o(e, [{
            ...
            key: "reorderChildren", value: function (e, t) {
                var n = t.removes, i = t.inserts, o = e.childNodes, r = {};
    ...
    var n = (t.getDomIndex = function (e, t, i) {
        ...
        if (t) {
            i(o, a, a) && (r[a] = t);
            var s = n.children;
            if (s)for (var l = t.childNodes, c = 0; c < s.length; ++c) {
                var d = s[c];
                ++a;
    ...
    var i = n(2), o = (t.listDiff = function (e, t) {
        function n(e, t, n) {
            return e.splice(t, 1), {index: t, key: n}
        }

        var a = o(e), s = a.keyIndexes;
        a.freeIndexes;
        if ((0, i.isEmptyObject)(s))return {children: t, moves: null};
        var l = o(t), c = l.keyIndexes, d = l.freeIndexes;
        if ((0, i.isEmptyObject)(c))return {children: t, moves: null};
        for (var u = [], h = 0, p = 0, g = 0; g < e.length; ++g) {
            var f = e[g], v = r(f);
            if (v)if (c.hasOwnProperty(v)) {
                var m = c[v];
                u.push(t[m])
            } else++p, u.push(null); else if (h < d.length) {
                var b = d[h];
                u.push(t[b]), ++h
            } else++p, u.push(null)
        }
        ...
        for (var y = u.slice(0), x = 0, C = [], k = [], E = 0; E < t.length;) {
            ...
            B === T ? (++x, ++E) : T ? (B ? c[B] === E + 1 ? k.push({
                                ...
                                index: E
                                    ...
                                    key: T,
                                    index: E
                                })) : k.push({key: T, index: E}), ++E) : C.push(n(y, x, B))
        }
        for (; x < y.length;) {
            var D = y[x], P = r(D);
            C.push(n(y, x, P))
        }
        return C.length === p && 0 == k.length ? {children: u, moves: null} : {
                children: u,
                moves: {removes: C, inserts: k}
            }
    ...
    var o = function () {
        ...
        return o(e, null, [{
            ...
            key: "mergeData", value: function (e, t) {
                ...
                for (var i in t) {
                    var o = (0, r.parsePath)(i), a = (t[i], (0, r.getObjectByPath)(e, o, !1)), s = a.obj, l = a.key, c = (0, r.getObjectByPath)(n, o, !0), d = c.obj, u = c.key, h = c.changed;
                    s && (s[l] = t[i]), d && (h ? d[u] = t[i] : d[u] = {__value__: t[i], __wxspec__: !0})
                }
                return n
            }
        }]), e
    ...
    t.parsePath = function (e) {
        for (var t = e.length, n = [], i = "", o = 0, r = !1, a = !1, s = 0; s < t; s++) {
            var l = e[s];
            if ("\\" === l) s + 1 < t && ("." === e[s + 1] || "[" === e[s + 1] || "]" === e[s + 1]) ? (i += e[s + 1], s++) : i += "\\"; else if ("." === l) i && (n.push(i), i = ""); else if ("[" === l) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.enablePullUpRefresh = t.triggerPullUpRefresh = t.checkScrollBottom = t.getScrollHeight = t.getWindowHeight = void 0;
    var i = (n(2), 20), o = t.getWindowHeight = function () {
    ...
    }, a = 0, s = t.checkScrollBottom = function () {
        var e = a - window.scrollY <= 0;
        return a = window.scrollY, !!(window.scrollY + o() + i >= r() && e)
    }, l = !1, c = !0, d = t.triggerPullUpRefresh = function () {
    ...
    function t() {
        ...
        if (document.getElementsByTagName("head")[0].insertBefore(t, document.getElementsByTagName("head")[0].firstChild), t.styleSheet) t.styleSheet.disabled || (t.styleSheet.cssText = e); else try {
            t.innerHTML = e
        } catch (n) {
            t.innerText = e
        }
    ...
    wx.version = {updateTime: "2016.12.22 20:03:49", info: "", version: 30};
