!function (e, t) {
    ...
    return function (e) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var r = n(3), i = o(r), s = !1, a = [];
        window.showDebugInfo = function (e, t) {
            var n = a.filter(function (n) {
                var o = !e || (Array.isArray(e) ? e.includes(n.type) : n.type === e), r = !t || (Array.isArray(t) ? t.includes(n.eventName) : n.eventName === t);
                if (o && r)return n
            });
            ...
            }, {fun: "closeDebug"}, {fun: "showDebugInfoTable"}, {fun: "openToolsLog"}, {fun: "openVendor"}, {fun: "showRequestInfo"}])
            ...
            i["default"].sendMsgToNW({sdkName: "__open-tools-log"})
        }, window.openVendor = function () {
            i["default"].sendMsgToNW({sdkName: "__open-tools-vendor"})
        }, window.showNewFeatureCheck = function () {
            i["default"].sendMsgToNW({sdkName: "__show-new-feature-check"})
        };
        var u = function () {
            return s
        }, c = function (e, t) {
        ...
        t["default"] = {debugLog: c, debugInfo: l, isDev: u}
    }, function (e, t, n) {
        "use strict";
        function o(e) {
            return e && e.__esModule ? e : {"default": e}
        ...
        var m = function (e) {
            e.to = "contentscript", e.comefrom = "webframe", e.webviewID = webViewId, window.postMessage(e, "*")
        }, brigeToNW = function (e, t, n) {
            var o = (0, i.isSyncSDK)(e), r = {sdkName: e, args: t, callbackID: n};
            o ? _(r) : sendMsgToNW(r)
        };
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.isSyncSDK = n, t.isLockSDK = o;
        var r = t.appconfig = Object.assign({
            domain: [""],
            networkTimeout: {request: 3e4, connectSocket: 3e4, uploadFile: 3e4, downloadFile: 3e4}
        }, __wxConfig), i = t.projectConfig = r.projectConfig || {};
        ...
        t["default"] = {isTourist: n, fake: r, check: i}
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        ...
        e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (e) {
            ...
            } else if (i(n))for (a = Array.prototype.slice.call(arguments, 1), c = n.slice(), r = c.length, u = 0; u < r; u++)c[u].apply(this, a);
            return !0
        ...
        var i = n(2), s = o(i), a = n(6), u = o(a), c = n(9), l = o(c), f = {
            onSocketOpen: [],
            onSocketError: [],
            onSocketMessage: [],
            onSocketClose: [],
        ...
        }, d = {onShareAppMessage: !0}, p = {onAppShow: !1};
        u["default"].on("triggerOnEvent", function (e, t, n) {
            if (f[e]) {
                var o = f[e], r = !0, i = !1, s = void 0;
                try {
        ...
        function n(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function () {
                }, o = Object.assign({title: __wxConfig.app_nickname, desc: "", imgUrl: ""}, e);
            n(o, t)
        }
        ...
        function r(e, t, n, o) {
            if (s["default"].debugLog(new Date + " WeixinJSBridge publish " + e, arguments), t && 0 !== e.indexOf("canvas")) {
                var r = JSON.stringify(t), i = r.length;
            ...
            s["default"].debugInfo({
                ...
                appData: __wxAppData,
                sdkName: "send_app_data"
            }), u["default"].sendMsgToNW({eventName: e, data: t, webviewIds: n, sdkName: "publish"})
        }

        Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = r;
        var i = n(2), s = o(i), a = n(3), u = o(a), c = n(4)
    }, function (e, t, n) {
        "use strict";
        function o(e) {
            return e && e.__esModule ? e : {"default": e}
        ...
        function s(e, t, n) {
            ...
            if (b.Permission[e]) {
                ...
                if (0 === r.state)return o({errMsg: e + ":fail no permission"}), !1
            }
            return !0
        }
        ...
        function a(e, t, n) {
            if (c["default"].debugLog(new Date + " WeixinJSBridge invoke " + e, arguments), !f["default"].check.apply(this, arguments)) {
                var o = (0, b.isLockSDK)(e), i = +new Date;
                if (!(o && i - S < 200) && (S = o ? i : 0, c["default"].debugInfo({
                        type: "invoke",
                        eventName: e,
                        data: arguments,
                        timesmap: new Date
                    }), s(e, t, n)))if (M[e]) M[e].apply(this, arguments); else {
        ...
        var u = n(2), c = o(u), l = n(5), f = o(l), d = n(6), p = (o(d), n(3)), v = o(p), g = n(13), h = o(g), _ = n(16), m = o(_), w = n(15), y = o(w), b = n(4), M = Object.assign(m["default"], h["default"]), S = 0, k = {};
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var r = n(6), i = o(r), s = n(5), a = (o(s), n(14)), u = n(4), c = n(15), l = null, f = 0, d = function (e, t, n) {
            if (f++, f > u.MaxRequestConcurrent)return f--, console.group(new Date + " wx.request 错误"), console.error("同时最多发起 " + u.MaxRequestConcurrent + " 个 wx.request 请求，更多请参考文档：https://mp.weixin.qq.com/debug/wxadoc/dev/api/network-request.html"), console.groupEnd(), void(n && n({errMsg: "request:fail"}));
            var o = t.url, r = t.header || {};
            if (!(0, c.checkUrl)(o))return f--, void(n && n({errMsg: "request:fail"}));
            if (!(0, a.checkTLS)(o))return f--, void(n && n({errMsg: "request:fail 小程序要求的 TLS 版本必须大于等于 1.2"}));
            var s, l = new XMLHttpRequest, d = t.method || "POST", p = (t.complete, u.appconfig.networkTimeout && u.appconfig.networkTimeout.request);
                        ...
                        if (r) {
                            var u = function () {
                                f--, s && clearTimeout(s), (0, a.checkTLS)(t.url) ? n && n({
                                        ...
                                        data: l.responseText,
                                        statusCode: e
                                    }) : n && n({errMsg: "request:fail 小程序要求的 TLS 版本必须大于等于 1.2"})
                            };
            ...
            "POST" != d || h || l.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), l.setRequestHeader("X-Requested-With", "XMLHttpRequest"), "number" == typeof p && (s = setTimeout(function () {
                l.abort("timeout"), t.complete && t.complete(), t.complete = null, f--, n && n({errMsg: "request:fail"})
            }, p));
            var w = "string" == typeof t.data ? t.data : null;
            try {
                l.send(w)
            } catch (y) {
                f--, n && n({errMsg: "request:fail"})
            }
        }, p = function (e, t, n) {
            var o = t.url, r = t.header;
            if (!(0, c.checkUrl)(o, "webscoket"))return void(n && n({errMsg: "connectSocket:fail"}));
            l = new WebSocket(o);
            for (var s in r)r.hasOwnProperty(s);
            l.onopen = function (e) {
                i["default"].emit("triggerOnEvent", "onSocketOpen", e)
            }, l.onmessage = function (e) {
                i["default"].emit("triggerOnEvent", "onSocketMessage", {data: e.data})
            ...
            l ? (l.close(), l = null, n && n({errMsg: "closeSocket:ok"})) : n && n({errMsg: "closeSocket:fail"})
        }, g = function (e, t, n) {
            var o = t.data;
            if (l)try {
                l.send(o), n && n({errMsg: "sendSocketMessage:ok"})
            } catch (r) {
                n && n({errMsg: "sendSocketMessage:fail " + r.message})
            } else n && n({errMsg: "sendSocketMessage:fail"})
        };
        t["default"] = {request: d, connectSocket: p, sendSocketMessage: g, closeSocket: v}
    }, function (e, t, n) {
        "use strict";
        function o(e) {
            return e && e.__esModule ? e : {"default": e}
        ...
        function i(e) {
            ...
            if (void 0 === t) {
                var o = f++;
                return l[e] = {isReady: n, id: o}, !0
            }
            if (!t.isReady)return !0;
            var i = !1, s = t.protocol;
            return s && (s = s.replace("TLS ", ""), i = parseFloat(s) >= 1.2), i
        }

        Object.defineProperty(t, "__esModule", {value: !0}), t.securityDetails = t.checkTLS = void 0;
        var s = n(5), a = o(s), u = n(6), c = o(u), l = window.securityDetails = {}, f = 1e4;
        ...
        function r(e, t) {
            ...
            try {
                var n = function () {
                    ...
                    for (var o = 0; o < n.length; o++)if (e && 0 === e.indexOf(n[o]))return {v: !0};
                    var r = [];
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            }, s = n(5), a = o(s), u = n(4), c = function (e, t, n) {
            return !!r(t.url, "upload") || (n({errMsg: e + ":fail illegal host"}), !1)
        }, l = function (e, t, n) {
            return !!r(t.url, "download") || (n({errMsg: e + ":fail illegal host"}), !1)
        };
        e.exports = {uploadFile: c, downloadFile: l, checkUrl: r}
    }, function (e, t) {
        "use strict";
        ...
        function n() {
            ...
            var e = ["Promise", "chrome", "Caches", "performance ", "getComputedStyle", "openDatabase"];
